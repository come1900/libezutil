/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
/*
 * rand_write.c - /home/wujj/src/libs/src_ezutil
 *
 * Copyright (C) 2006 ezlibs.com, All Rights Reserved.
 *
 * $Id: rand_write.c, v 1.0.0.1 2006-03-11 13:23:35 wjj Exp $
 *
 *  Explain:
 *     -
...
#ifndef lint
static char rcsid[] = "$Tools: rand_write.c,v 1.0 2006-3-11 13:22 ezlibs.com Exp $";
#endif /* not lint */
...
int main(int argc, char *argv[])
{
    ...
    while (run==1)
    {
        ...
        printf("round %4u completed: %4d records , %10u Bytes written in %8ld seconds.\n", st_round , record, write_bytes_from+write_bytes_to, tt_end-tt_start);
        printf("---------------------------------------------------------------------------------------------------------\n");
        break;
#endif //VERIFY
