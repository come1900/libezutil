/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
/*
 * crc16_xmoden.c - _explain_
 *
 * Copyright (C) 2011 ezlibs.com, All Rights Reserved.
 *
 * $Id: crc16_xmoden.c 5884 2022-07-01 09:24:07Z WuJunjie $
 *
 *  Explain:
 *     -explain-
 *
 *  Update:
 *     2022-07-01 09:24:07  Create
 */
/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
...
int main(int argc, char *argv[])
{
    ...
    //查表法
    crc = do_crc_table(test_buff, sizeof(test_buff));
    printf("CRC-16/XMODEM : 0x%x\n", crc);

    //直接计算法
    crc = do_crc(test_buff, sizeof(test_buff));
    printf("CRC-16/XMODEM : 0x%x\n", crc);
