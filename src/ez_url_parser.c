/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
/*
 * ez_url_parser.c - _explain_
 *
 * Copyright (C) 2011 ezlibs.com, All Rights Reserved.
 *
 * $Id: ez_url_parser.c 5884 2016-11-23 04:46:44Z WuJunjie $
 *
 *  Explain:
 *     -explain-
 *
 *  Update:
 *     2016-11-23 04:46:44  Create
 */
/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
 ...
 */
ez_parsed_url_t *
ez_parse_url(const char *url)
{
    ez_parsed_url_t *purl;
    const char *tmpstr;
    const char *curstr;
    int len;
    int i;
    ...
    purl = malloc(sizeof(ez_parsed_url_t));
    if ( NULL == purl ) {
        return NULL;
    }
    purl->scheme = NULL;
 ...
 */
void
ez_parsed_url_free(ez_parsed_url_t *purl)
{
    if ( NULL != purl ) {
        if ( NULL != purl->scheme ) {
            free(purl->scheme);
