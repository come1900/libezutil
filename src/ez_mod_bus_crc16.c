/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
/*
 * mod_bus_crc_2.c - _explain_
 *
 * Copyright (C) 2011 ezlibs.com, All Rights Reserved.
 *
 * $Id: mod_bus_crc_2.c 5884 2018-02-02 09:30:05Z WuJunjie $
 *
 *  Explain:
 *     -tnp4200-
 *
 *  Update:
 *     2018-02-02 09:30:05  Create
 */
/*-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
...
unsigned char buf[]={0x01 , 0x03 , 0x00 , 0x00 , 0x00 , 0x02};
    ...
    CRC = ez_MODBUS_CRC16(buf, sizeof(buf));

    printf("CRC:0x%0x, -- 0x%0x, 0x%0x\n", CRC, CRC&0xff/**/, (CRC>>8)&0xff);

    // if CRC is 1241, put as : ... 41 12
